...
JobName="ODS_S_Tran_tmp_MainJob"
LogFile="SNP_ETL_for_repair_MAIN_Log_${JobName}_${DateTime}.txt"
#LogFile="TuMTest.txt"
...
$ETLPath/kitchen.sh -rep:$RepPath -job:$JobName -user:$User -dir:/Audit/ -pass:$Pass  -loglevel:$LogLevel #>> $ETL_LOG 
